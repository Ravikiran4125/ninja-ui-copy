...
import { Logger, Shinobi } from "../../src";
import { researchDirectorShinobi } from "../definitions/shinobi";
import { fileManagerShuriken, webSearchShuriken } from "../definitions/shurikens";
